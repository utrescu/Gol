...
Jugador1 = { 
	Nom = "Pep1", Numero = 2, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1->porter 2->defensa 3->migcapista 4->davanter
	JugaDe=2,
...
Jugador2 = { 
	Nom = "Pep2", Numero = 3, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1-> porter 2-> defensa 3->migcapista 4->davanter
	JugaDe=2,
...
Jugador3 = { 
	Nom = "Pep3", Numero = 4, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1-> porter 2-> defensa 3->migcapista 4->davanter
	JugaDe=2,
...
Jugador4 = { 
	Nom = "Pep4", Numero = 5, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1-> porter 2-> defensa 3->migcapista 4->davanter
	JugaDe=3,
...
Jugador5 = { 
	Nom = "Pep5", Numero = 6, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1-> porter 2-> defensa 3->migcapista 4->davanter
	JugaDe=4,
...
Jugador6 = { 
	Nom = "Pep6", Numero = 7, Imatge = "blau.lua", 
	-- Per les animacions
	Animacions = 3,	
	-- De què juga el jugador: 1-> porter 2-> defensa 3->migcapista 4->davanter
	JugaDe=4,
